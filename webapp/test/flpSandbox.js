		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ConsumeApp",
									"targetURL": "#consumeconsumingapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"consumeconsumingapp2-display": {
								"semanticObject": "consumeconsumingapp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=consume.consumingapp2",
									"url": sap.ui.require.toUrl("consume/consumingapp2")
								}
							}
						}
					}
